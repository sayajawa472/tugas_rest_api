...
func TestCreateCategorySucces(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodPost, "http://localhost:3000/apo/categories", requestBody)
...
func TestUpdateCattegoryRequest(t *testing.T) {
	db := setupTestDB()
	truncateCategory(db)
...
func TestListCategoriesSucces(t *testing.T) {
	...
	assert.Equal(t, category1.Nama, categoryResponse1["name"])

	assert.Equal(t, category2.Id, int(categoryResponse2["id"].(float64)))
	assert.Equal(t, category2.Nama, categoryResponse2["name"])
}
